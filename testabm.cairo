...
func getoutput{
    ...
    let (final_location_x,final_location_y,new_velocity_x,new_velocity_y) = updateLocation(x=x,y=y,new_velocity_x=new_velocity_x,new_velocity_y=new_velocity_y)
...
func updateLocation{
        ...
        let(final_location_x) = new_velocity_x+x;
        let(final_location_y) = new_velocity_y+y;
